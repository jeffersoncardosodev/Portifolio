...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Dashboard administrativo para gerenciamento de recursos empresariais.',
      tech: ['React', 'NodeJS', 'MongoDB', 'ChartJS'],
      image: 'bg-gray-800',
    },
    {
    ...
    },
    {
      ...
      tech: ['React', 'NextJS', 'Markdown', 'Styled Components'],
      image: 'bg-gray-800',
    },
  ];
