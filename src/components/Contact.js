      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto bg-gray-900 rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="bg-gray-800 text-white px-6 py-3 rounded-md font-medium hover:bg-gray-700 transition duration-300 w-full md:w-auto"
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 justify-center space-x-8">
            ...
            <a href="tel:+5511999999999" className="flex items-center text-gray-300 hover:text-white">
              <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
